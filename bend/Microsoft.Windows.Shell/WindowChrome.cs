...
namespace Microsoft.Windows.Shell
{
    ...
    public class WindowChrome : Freezable
    {
        ...
        static public void EnableWindowDropShadow(IntPtr windowHandle)
        {
            int flags = Standard.NativeMethods.GetClassLongPtr(windowHandle, GCLP.GCL_STYLE);
            Standard.NativeMethods.SetClassLongPtr(windowHandle, GCLP.GCL_STYLE, (IntPtr)(flags | (int)CS.DROPSHADOW));    
        }

        static public void DisableWindowTransitions(IntPtr windowHandle)
        {
            Standard.NativeMethods.DwmSetWindowAttributeTransitionsForceDisabled(windowHandle, /*transitionsForceDisabled*/true);
        }

...
namespace Standard
{
    ...
    internal static class NativeMethods
    {
        ...
        [SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
        public static void DwmSetWindowAttributeTransitionsForceDisabled(IntPtr hwnd, bool transitionsForceDisabled)
        {
            Assert.IsTrue(Utility.IsOSWindows7OrNewer);
            int dwDisallow = (int)(transitionsForceDisabled ? Win32Value.TRUE : Win32Value.FALSE);
            _DwmSetWindowAttribute(hwnd, DWMWA.TRANSITIONS_FORCEDISABLED, ref dwDisallow, sizeof(int));
        }
        ...
        private static extern int GetClassLongPtr32(IntPtr hWnd, GCLP nIndex);

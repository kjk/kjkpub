...
namespace ICSharpCode.AvalonEdit.Editing
{
	...
	public sealed class SimpleSelection : Selection, ISegment
	{
        ...
        readonly bool isFindOnPageSelection;

		/// <summary>
		/// Creates a new SimpleSelection instance.
		/// </summary>
		public SimpleSelection(int startOffset, int endOffset, bool isFindOnPageSelection = false)
		{
			this.startOffset = startOffset;
			this.endOffset = endOffset;
            this.isFindOnPageSelection = isFindOnPageSelection;
		}
        ...
        /// <summary>
        ///     Gets if this is a selection for find on page
        /// </summary>
        public override bool IsFindOnPageSelection() { return this.isFindOnPageSelection; }
